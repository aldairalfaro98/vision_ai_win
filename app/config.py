...
class Settings(BaseSettings):
    ...
    max_frames: int = Field(default=60, ge=1, le=300)
    ...
    # --- Blink ---
    blink_baseline_frames: int = Field(default=3, ge=1, le=30)
    blink_close_ratio: float = Field(default=0.75, ge=0.1, le=1.0)
    ...
    # --- Decision ---
    decision_mode: str = Field(default="strict")  # "strict" | "balanced"
